...
function load(token = null){
	//let url = `/v1/prices/cheap?origin=MOW&destination=-&token=${_token}`;
	...
	let url = `/v2/prices/month-matrix?currency=uah&origin=LED&destination=HKT&show_to_affiliates=true&token=${_token}`;
